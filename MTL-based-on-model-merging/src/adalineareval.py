...
class Lambda(torch.nn.Module):
    def __init__(self,paramslist,model,names,datasets):
        ...
        values = [0.1249, 0.0379, 0.1456, 0.4073, 0.3616, 0.1796, 0.1387, 0.1386]
...
if __name__=="__main__":
    ...
    log = create_log_dir(args.logs_path, 'log_{}_ada_LinearTAeval.txt'.format(str_time_))
    args.log = log
    ...
    with torch.no_grad():
        ...
        log.info(' Avg ACC:' + str(Total_ACC / len(datasets)) + '\n')