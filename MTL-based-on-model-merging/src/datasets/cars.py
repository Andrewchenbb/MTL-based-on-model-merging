...
class PytorchStanfordCars(VisionDataset):
    ...
    def __init__(
        ...
        self._base_folder =  "E:\\Chenzebin\\data\\stanford_cars"
    ...
    def _check_exists(self) -> bool:
        if not os.path.isdir(os.path.join(self._base_folder, "devkit")):
            return False
        return True
...
class Cars:
    def __init__(self,
                 preprocess,
                 location="E:\\Chenzebin\\data",#os.path.expanduser('~/data'),
                 batch_size=32,
                 num_workers=16):
        # Data loading code
